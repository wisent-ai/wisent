...
def combine_all_benchmark_plots(
    ...
    output_path: str = "/workspace/results/combined_plots/all_benchmarks_combined.png",
...
def get_default_benchmark_configs() -> Dict[str, Dict[str, str]]:
    ...
    for benchmark in ["gsm8k", "boolq", "sst2", "cb"]:
        plots_dir = f"{base_dir}/{benchmark}"

        configs[benchmark.upper()] = {
            "continuation_token": f"{plots_dir}/{benchmark}_aggregation_continuation_token_plot.png",
            "last_token": f"{plots_dir}/{benchmark}_aggregation_last_token_plot.png",
            "first_token": f"{plots_dir}/{benchmark}_aggregation_first_token_plot.png",
            "mean_pooling": f"{plots_dir}/{benchmark}_aggregation_mean_pooling_plot.png",
            "choice_token": f"{plots_dir}/{benchmark}_aggregation_choice_token_plot.png",
            "max_pooling": f"{plots_dir}/{benchmark}_aggregation_max_pooling_plot.png",
            "combined_aggregations": f"{plots_dir}/{benchmark}_aggregations_combined_plot.png",
            "train_size_improvement": f"{plots_dir}/{benchmark}_train_size_improve_plot.png",
        }
...
if __name__ == "__main__":
    ...
    output_file = combine_all_benchmark_plots(
        ...
        output_path="/workspace/results/all_benchmarks_combined.png",
        figsize=(24, 32),
        dpi=150,
    )
