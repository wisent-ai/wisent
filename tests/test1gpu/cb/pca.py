"""
PCA Analysis for CB Activations
...
Uses 100 questions from CB benchmark.
For each layer:
...
def extract_activations(
    ...
    """
    print(f"Extracting activations from {num_questions} CB questions")
    print("=" * 80)
...
def perform_pca_analysis(data: dict, num_layers: int, num_questions: int):
    ...
    fig.suptitle(f'PCA Analysis: CB Activations (continuation_token)\n'
    ...
    # Save figure
    output_path = "/workspace/results/cb/cb_pca.png"
