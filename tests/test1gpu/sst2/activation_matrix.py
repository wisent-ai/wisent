...
def load_pairs(limit: int, preferred_doc: str = "training"):
    """Load contrastive pairs from SST2 benchmark.
    ...
    pairs = extractor.extract_contrastive_pairs(sst2_task, limit=limit, preferred_doc=preferred_doc)
...
if __name__ == "__main__":
    ...
    result = create_activations_matrix(
        ...
        num_questions=50,
        output_path="/workspace/results/sst2/sst2_activations_matrix.pkl",
    ...
    print("  import pickle")
    print("  with open('/workspace/results/sst2/sst2_activations_matrix.pkl', 'rb') as f:")
