...
def plot_combined_aggregations(
    ...
    num_test: int,
    output_path: str = "/workspace/results_1gpu/sst2/sst2_aggregations_combined_plot.png",
):
...
if __name__ == "__main__":
    ...
    for agg_method in agg_strategies:
        ...
        # Save to JSON file
        output_dir = "/workspace/results_1gpu/sst2"
        ...
        plot_individual_aggregation(
            ...
            num_test=num_test,
            output_path=f"/workspace/results_1gpu/sst2/sst2_aggregation_{agg_name}_plot.png",
        )
