"""
PCA Analysis for SST2 Activations
...
def perform_pca_analysis(data: dict, num_layers: int, num_questions: int):
    ...
    fig.suptitle(f'PCA Analysis: SST2 Activations (continuation_token)\n'
    ...
    # Save figure
    output_path = "/workspace/results/sst2/sst2_pca.png"
