"""
3D PCA Analysis for CB Activations
...
def perform_pca_analysis_3d(data: dict, num_layers: int, num_questions: int):
    ...
    fig.suptitle(f'3D PCA Analysis: CB Activations (continuation_token)\n'
    ...
    # Save figure
    output_path = "/workspace/results/cb/cb_pca_3d.png"
