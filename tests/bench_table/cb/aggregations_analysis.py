...
def plot_combined_aggregations(
    ...
    num_test: int,
    output_path: str = "tests/bench_table/cb/plots/aggregations_combined_plot.png",
):
...
if __name__ == "__main__":
    ...
    for agg_method in agg_strategies:
        ...
        # Save to JSON file
        output_dir = Path("tests/bench_table/cb/results")
        ...
        plot_individual_aggregation(
            ...
            num_test=num_test,
            output_path=f"tests/bench_table/cb/plots/aggregation_{agg_name}_plot.png",
        )
