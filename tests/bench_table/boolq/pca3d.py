"""
3D PCA Analysis for BoolQ Activations
...
def perform_pca_analysis_3d(data: dict, num_layers: int, num_questions: int):
    ...
    fig.suptitle(f'3D PCA Analysis: BoolQ Activations (continuation_token)\n'
    ...
    # Save figure
    output_path = "/workspace/results/boolq/boolq_pca_3d.png"
