...
def plot_combined_aggregations(
    ...
    num_test: int,
    output_path: str = "/workspace/results/boolq/boolq_aggregations_combined_plot.png",
):
...
if __name__ == "__main__":
    ...
    for agg_method in agg_strategies:
        ...
        plot_individual_aggregation(
            ...
            num_test=num_test,
            output_path=f"/workspace/results/boolq/boolq_aggregation_{agg_name}_plot.png",
        )
