"""
PCA Analysis for BoolQ Activations
...
Uses 100 questions from BoolQ benchmark.
For each layer:
...
def extract_activations(
    ...
    """
    print(f"Extracting activations from {num_questions} BoolQ questions")
    print("=" * 80)
...
def perform_pca_analysis(data: dict, num_layers: int, num_questions: int):
    ...
    fig.suptitle(f'PCA Analysis: BoolQ Activations (continuation_token)\n'
