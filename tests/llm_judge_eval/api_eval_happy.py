...
with open("tests/llm_judge_eval/prompt_eval_happy.py") as f: #change
    prompt_template = f.read().strip('"""\n')

# Load results from results.json
with open("tests/llm_judge_eval/gen_results_happy.json") as f: #change
    results = json.load(f)
...
output_file = "tests/llm_judge_eval/api_evaluation_results_happy.json" #change
