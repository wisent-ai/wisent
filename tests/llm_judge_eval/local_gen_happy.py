...
rot_data.use("custom")
absolute_path = "./tests/llm_judge_eval/happy.json" 
...
with open("tests/llm_judge_eval/happy_prompts") as f: 
...
output_file = f"./tests/llm_judge_eval/gen_results_happy.json"
