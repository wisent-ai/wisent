...
from wisent.extractors.hf.flores_task_names_part1 import FLORES_TASK_NAMES_PART1
from wisent.extractors.hf.flores_task_names_part2 import FLORES_TASK_NAMES_PART2
