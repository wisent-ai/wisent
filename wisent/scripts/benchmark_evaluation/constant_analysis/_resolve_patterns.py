...
HARDWARE_PATTERNS = [
    ...
    re.compile(r"MAX_TASKS_PER_PROC"),
...
MODEL_PATTERNS = [
    ...
    re.compile(r"DEFAULT_LAYER_CONFIG$"),
    re.compile(r"DEFAULT_NUM_HIDDEN_LAYERS$"),
    re.compile(r"DEFAULT_STEERING_LAYERS$"),
    re.compile(r"SEARCH_MAX_LAYER_CAP$"),
    re.compile(r"CLASSIFIER_LAYER_RANGE_END$"),
    re.compile(r"DEFAULT_METHOD_LAYER_RANGE_END$"),
    ...
    re.compile(r"GROM_SENSOR_LAYER_DEFAULT$"),
    re.compile(r"TEST_DETECTOR_DEFAULT_LAYER$"),
    re.compile(r"QWEN3_4B_DEFAULT_LAYER$"),
    re.compile(r"COMPARISON_STEERING_LAYER$"),
    re.compile(r"SUBSPACE_HIDDEN_DIM_LARGE$"),
    re.compile(r"THRESHOLD_HIDDEN_DIM_LARGE$"),
...
DEFINITION_PATTERNS_PHYSICAL = [
    ...
    re.compile(r"^DEFAULT_VIDEO_FPS$"),
    re.compile(r"^GEO_DEFAULT_DIRECTION_ANGLE$"),
...
DEFINITION_PATTERNS_NUMERICAL = [
    ...
    re.compile(r"^TIKHONOV_REG$"),
    re.compile(r"^EARLY_STOP_TOL$"),
    re.compile(r"^MIN_NORM_THRESHOLD$"),
...
DEFINITION_PATTERNS_ENUMS = [
    ...
    re.compile(r"^WEIGHT_MOD_DEFAULT_COMPONENTS$"),
    re.compile(r"^ROLE_PLAY_TOKENS$"),
    re.compile(r"^CHARTQA_.*_DELTAS$"),
    re.compile(r"^OPTUNA_PRZELOM_TARGET_MODES$"),
    re.compile(r"^OPTUNA_WICHER_CONCEPT_DIMS$"),
    re.compile(r"^MAX_NEW_TOKENS_VERIFY_SINGLE$"),
    re.compile(r"^STEERING_OPTI_JUDGE_MAX_TOKENS$"),
