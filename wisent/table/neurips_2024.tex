...
\rowcolor{catMath} MATH\textendash500 \cite{huggingfaceh4_math500_2024} & \TG & \textbf{Num+1} & mathematics (contest) \\
\rowcolor{catMath} AIME \cite{mathai2025aime25}\cite{maxwelljia2024aime} & \TG & \textbf{Num+1} & mathematics (contest) \\
\rowcolor{catMath} HMMT \cite{matharena2025hmmt} & \TG & \textbf{Num+1} & mathematics (contest) \\
...
banking77 \cite{} & \TG & \textbf{MC-FirstDistr} & reasoning \\
boolq \cite{} & \LL & \textbf{2C-Flip} & reasoning \\
boolq-seq2seq \cite{} & \TG & \textbf{2C-Flip} & reasoning \\
cb \cite{} & \LL & \textbf{MC-FirstDistr} & reasoning \\
claim stance topic \cite{} & \TG & \textbf{MC-FirstDistr} & reasoning \\
cnn dailymail \cite{} & \TG & \textbf{Generic} & reasoning \\
dpedia 14 \cite{} & \TG & \textbf{MC-FirstDistr} & reasoning \\
ethos binary \cite{} & \TG & \textbf{MC-FirstDistr} & reasoning \\
financial tweets \cite{} & \TG & \textbf{MC-FirstDistr} & reasoning \\
squadv2 \cite{} & \TG & \textbf{RC-Abstain} & reasoning \\
logieval \cite{} & \TG & \textbf{MC-FirstDistr} & reasoning \\
ledgar \cite{} & \TG & \textbf{MC-FirstDistr} & reasoning \\
logieval \cite{} & \TG & \textbf{MC-FirstDistr} & reasoning \\
penn treebank \cite{} & \PPL & \textbf{LM-CorruptCont} & reasoning \\
medical abstracts \cite{} & \TG & \textbf{MC-FirstDistr} & reasoning \\
unfair tos \cite{} & \TG & \textbf{LM-CorruptCont} & reasoning \\
record \cite{} & \LL & \textbf{MC-FirstDistr} & reasoning \\
stsb \cite{} & \TG & \textbf{2C-Flip} & reasoning \\
sglue-rte \cite{} & \LL & \textbf{2C-Flip} & reasoning \\
xsum \cite{} & \TG & \textbf{Generic} & reasoning \\
yashoo answers topics \cite{} & \TG & \textbf{MC-FirstDistr} & reasoning \\
\end{longtable}
...
afrimgsm direct amh \cite{} & \TG & \textbf{Num+1} & mathematics \\
aime \cite{} & \TG & \textbf{Num+1} & mathematics \\
aime2024 \cite{} & \TG & \textbf{Num+1} & mathematics \\
aime2025 \cite{} & \TG & \textbf{Num+1} & mathematics \\
gsm \cite{} & \TG & \textbf{Num+1} & mathematics \\
hmmt \cite{} & \TG & \textbf{Num+1} & mathematics \\
math \cite{} & \TG & \textbf{Num+1} & mathematics \\
math500 \cite{} & \TG & \textbf{Num+1} & mathematics \\
polymath \cite{} & \TG & \textbf{Num+1} & mathematics \\
\hline
\end{longtable}
...
afrimmlu direct amh \cite{} & \LL & \textbf{MC-FirstDistr} & multilingual \\
afrixnli en direct amh \cite{} & \TG & \textbf{MC-FirstDistr} & multilingual \\
arabic exams \cite{} & \LL & \textbf{MC-FirstDistr} & multilingual \\
bangla mmlu \cite{} & \LL & \textbf{MC-FirstDistr} & multilingual \\
basque glue \cite{} & \LL & \textbf{2C-Flip} & multilingual \\
copa \cite{} & \LL & \textbf{2C-Flip} & multilingual \\
global mmlu \cite{} & \LL & \textbf{MC-FirstDistr} & multilingual \\
m mmlu \cite{} & \LL & \textbf{MC-FirstDistr} & multilingual \\
m mmlu \cite{} & \LL & \textbf{2C-Flip} & multilingual \\
noticia \cite{} & \LL & \textbf{Generic} & multilingual \\
phrases ca-va \cite{} & \TG & \textbf{Generic} & multilingual \\
wmt14 \cite{} & \TG & \textbf{L-Shuff} & multilingual \\
wmt16 \cite{} & \TG & \textbf{L-Shuff} & multilingual \\
\hline
\end{longtable}
...
babilong \cite{} & \LL & \textbf{MC-RandDistr} & longcontext \\
...
glianorex \cite{} & \LL & \textbf{MC-FirstDistr} & medical \\
...
wikitext103 \cite{} & \PPL & \textbf{LM-CorruptCont} & general knowledge \\
