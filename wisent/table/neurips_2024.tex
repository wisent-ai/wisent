...
\begin{description}
  ...
  \item[Boolean Flip \textnormal{[Bool-Flip]}] Binary tasks (BoolQ): negative is the opposite boolean label.
...
\rowcolor{catRC} BoolQ \cite{clark2019boolq} & \LL & \textbf{Bool-Flip} & boolean RC \\
