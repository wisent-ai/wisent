...
def detect_multiple_concepts(
    ...
    Uses SpectralClustering on L2-normalized difference vectors.
    Searches all possible k values - no arbitrary limits.
    """
    try:
        ...
        # L2 normalize (critical for handling magnitude variation)
        ...
        # Search all possible k values (need at least 2 samples per cluster for silhouette)
        max_k = len(diff_normalized) // 2
