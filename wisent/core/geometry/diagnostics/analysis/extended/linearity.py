...
def check_linearity(
    ...
    from wisent.core.diagnostics import detect_geometry_structure, GeometryAnalysisConfig
...
from wisent.core.diagnostics.analysis._linearity_from_activations import (
