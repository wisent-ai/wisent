"""
GeodesicOTSteeringObject — steering object for geodesic optimal transport.
...
__all__ = ["GeodesicOTSteeringObject"]


class GeodesicOTSteeringObject(BaseSteeringObject):
    """Steering object that applies geodesic OT-derived displacements."""

    method_name = "geodesic_ot"
    ...
    @classmethod
    def from_dict(cls, data: Dict[str, Any]) -> "GeodesicOTSteeringObject":
