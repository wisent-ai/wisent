...
from wisent.core.control.generation.synthetic.cleaners.core.atoms import CleanStep
from wisent.core.primitives.contrastive_pairs.core.pair import ContrastivePair
from wisent.core.control.generation.synthetic.cleaners.core.atoms import CleanStepStats

from wisent.core.control.generation.synthetic.cleaners.methods.core.atoms import Refusaler
...
class RefusalerCleaner(CleanStep):
    ...
    def apply(self, items: ContrastivePairSet) -> ContrastivePairSet:
        ...
        example:
            ...
            >>> from wisent.core.primitives.contrastive_pairs.core.pair import ContrastivePair
            >>> from wisent.core.primitives.contrastive_pairs.core.io.response import PositiveResponse, NegativeResponse
            >>> from wisent.core.control.generation.synthetic.cleaners.methods.base_refusalers import SimpleRefusaler
            >>> from wisent.core.primitives.models.wisent_model import WisentModel
