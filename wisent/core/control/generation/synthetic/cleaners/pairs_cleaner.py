...
from wisent.core.control.generation.synthetic.cleaners.core.atoms import CleanStep, Cleaner
from wisent.core.control.generation.synthetic.cleaners.core.atoms import CleanerStats
...
class PairsCleaner(Cleaner):
    ...
    def clean(
        ...
        example:
            ...
            >>> from wisent.core.control.generation.synthetic.cleaners.methods.base_refusalers import BasesRefusaler
            >>> from wisent.core.control.generation.synthetic.cleaners.methods.base_dedupers import SimHashDeduper
            >>> from wisent.core.control.generation.synthetic.cleaners.cleaners import PairsCleaner
