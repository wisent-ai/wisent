...
from wisent.core.control.generation.prompts.core.atom import PromptPair, PromptStrategy, UnknownStrategyError
from wisent.core.utils.infra_tools.errors import FileLoadError, DuplicateNameError, InsufficientDataError
...
class PromptFormatter:
    ...
    def _discover_and_load(self) -> None:
        ...
        """
        try:
            import wisent.core.control.generation.prompts.prompt_strategies as strategies_pkg
        ...
        for module_info in pkgutil.iter_modules(strategies_pkg.__path__):
            ...
            module = importlib.import_module(f"wisent.core.control.generation.prompts.prompt_strategies.{name}")
