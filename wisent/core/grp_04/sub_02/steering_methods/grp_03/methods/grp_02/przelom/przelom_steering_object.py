"""
PrzelomSteeringObject — steering object for attention-transport method.
...
Same k-NN IDW pattern as SzlakSteeringObject.
"""
...
class PrzelomSteeringObject(BaseSteeringObject):
    """Steering object that applies attention-transport-derived displacements."""
    ...
    @classmethod
    def from_dict(cls, data: Dict[str, Any]) -> "PrzelomSteeringObject":
