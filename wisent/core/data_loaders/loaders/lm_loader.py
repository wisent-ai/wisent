...
class LMEvalDataLoader(BaseDataLoader):
    ...
    def load_lm_eval_task(task_name: str) -> ConfigurableTask | dict[str, ConfigurableTask]:
        ...
        group_task_expansions = {
            ...
            "lambada_multilingual_stablelm": ["lambada_openai_mt_stablelm_de", "lambada_openai_mt_stablelm_en", "lambada_openai_mt_stablelm_es", "lambada_openai_mt_stablelm_fr", "lambada_openai_mt_stablelm_it", "lambada_openai_mt_stablelm_nl", "lambada_openai_mt_stablelm_pt"],
            ...
            "okapi/mmlu_multilingual": ["m_mmlu_ar", "m_mmlu_bn", "m_mmlu_ca", "m_mmlu_da", "m_mmlu_de", "m_mmlu_es", "m_mmlu_eu", "m_mmlu_fr", "m_mmlu_gu", "m_mmlu_hi", "m_mmlu_hr", "m_mmlu_hu", "m_mmlu_hy", "m_mmlu_id", "m_mmlu_it", "m_mmlu_kn", "m_mmlu_ml", "m_mmlu_mr", "m_mmlu_ne", "m_mmlu_nl", "m_mmlu_pt", "m_mmlu_ro", "m_mmlu_ru", "m_mmlu_sk", "m_mmlu_sr", "m_mmlu_sv", "m_mmlu_ta", "m_mmlu_te", "m_mmlu_uk", "m_mmlu_vi", "m_mmlu_zh_cn", "m_mmlu_zh_hk", "m_mmlu_zh_tw", "m_mmlu_zh"],
            ...
            "evalita_llm": ["evalita-mp_te", "evalita-mp_sa", "evalita-mp_wic", "evalita-mp_hs", "evalita-mp_at", "evalita-mp_faq", "evalita-mp_ls", "evalita-mp_re"],
