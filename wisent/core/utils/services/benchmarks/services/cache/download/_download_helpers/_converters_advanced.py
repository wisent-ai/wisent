...
from wisent.core.utils.config_tools.constants import DISPLAY_TRUNCATION_MEDIUM, DISTRACTOR_NEARBY_MIN, DISTRACTOR_NEARBY_MAX, DISTRACTOR_MAX_COUNT
...
class AdvancedConvertersMixin:
    ...
    def _convert_hle_format(self, sample: Dict[str, Any]) -> List[Dict[str, Any]]:
        ...
        from wisent.core.utils.services.benchmarks import HLEExtractor
