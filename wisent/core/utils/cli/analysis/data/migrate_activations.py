...
def _create_hf_repo():
    ...
    from wisent.core.reading.data.hf.hf_config import HF_REPO_ID, HF_REPO_TYPE
    import os
...
def execute_migrate_activations(args):
    ...
    if action == "create-repo":
        ...
        from wisent.core.reading.data.hf.migration_verify import migrate_all
        migrate_all(
        ...
        from wisent.core.reading.data.hf.hf_writers import consolidate_index
        consolidate_index(dry_run=args.dry_run)

    elif action == "single":
        from wisent.core.reading.data.hf.migration import migrate_activation_table
        ...
        from wisent.core.reading.data.hf.migration import migrate_pair_texts
        ...
        from wisent.core.reading.data.hf.migration import migrate_raw_activation_table
        ...
        from wisent.core.reading.data.hf.migration_verify import verify_migration
        ok = verify_migration(
            model_name=args.model,
            task_name=args.benchmark,
            strategy=args.strategy,
