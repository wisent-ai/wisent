...
from wisent.core.utils.infra.core.hardware import eval_time_limit_s, eval_cpu_limit_s, eval_mem_limit_mb
...
def evaluate_docker_execution(args, input_data, responses, task_name, evaluation_results, task_results, task_config=None):
    ...
    from wisent.core.evaluators.benchmark_specific.coding.code_metrics.evaluator import CodingEvaluator, EvaluatorConfig, _make_schema
