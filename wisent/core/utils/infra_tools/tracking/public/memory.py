...
class MemoryTracker:
    ...
    def format_stats(self, stats: MemoryStats, detailed: bool = False) -> str:
        ...
        from wisent.core.utils.infra_tools.tracking._helpers.memory_helpers import format_stats
        return format_stats(stats, detailed)


# Re-export from helpers for backward compatibility
from wisent.core.utils.infra_tools.tracking._helpers.memory_helpers import (  # noqa: E402
    get_global_tracker,
    track_memory,
    get_memory_info,
    format_memory_usage,
