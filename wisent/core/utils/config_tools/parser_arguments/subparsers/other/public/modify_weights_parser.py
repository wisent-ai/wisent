...
from wisent.core.utils.config_tools.parser_arguments.other.modify_weights_parser_basic import setup_basic_modify_args
from wisent.core.utils.config_tools.parser_arguments.other.modify_weights_parser_advanced import setup_advanced_modify_args
