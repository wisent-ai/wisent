...
from wisent.core.contrastive_pairs.huggingface_pairs.hf_task_extractors.multilingual_benchmarks_part2 import (
    DarijaBenchExtractor,
    EusExamsExtractor,
)
from wisent.core.contrastive_pairs.huggingface_pairs.hf_task_extractors.multilingual_benchmarks_part3 import (
    LambadaMultilingualExtractor,
)
