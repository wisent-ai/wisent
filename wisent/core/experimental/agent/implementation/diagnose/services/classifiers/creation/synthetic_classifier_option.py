...
from wisent.core.experimental.agent.diagnose.classifiers._synthetic_system import (
    SyntheticClassifierSystem,
)
from wisent.core.experimental.agent.diagnose.classifiers._synthetic_functions import (
