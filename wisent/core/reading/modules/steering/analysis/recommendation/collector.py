...
from wisent.core.reading.data.enriched_builder import build_enriched_from_db, generate_and_collect_enriched
...
def collect_ground_truth(
    ...
    if benchmarks is None:
        if use_geometry_selection:
            from wisent.core.reading.zwiad.geometry_types import (
