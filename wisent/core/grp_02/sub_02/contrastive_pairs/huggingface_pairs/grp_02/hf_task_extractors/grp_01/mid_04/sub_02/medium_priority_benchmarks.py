...
from wisent.core.contrastive_pairs.huggingface_pairs.hf_task_extractors.medium_priority_halulens import (
    HalulensExtractor,
)
from wisent.core.contrastive_pairs.huggingface_pairs.hf_task_extractors.medium_priority_toxicity import (
    PolygloToxicityExtractor,
)
from wisent.core.contrastive_pairs.huggingface_pairs.hf_task_extractors.medium_priority_political import (
    PoliticalBiasExtractor,
)
