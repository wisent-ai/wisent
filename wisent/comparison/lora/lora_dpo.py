...
from wisent.core.utils.config_tools.constants import DPO_DEFAULT_BETA
...
def main():
    ...
    parser.add_argument("--num-pairs", type=int, default=None, help="Number of preference pairs (required)")
