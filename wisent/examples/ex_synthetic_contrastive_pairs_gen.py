...
# - db instructions
from wisent.synthetic.db_instructions.mini_dp import Default_DB_Instructions
db_instructions = Default_DB_Instructions()
# - cleaner
from wisent.synthetic.cleaners.pairs_cleaner import PairsCleaner
from wisent.synthetic.cleaners.refusaler_cleaner import RefusalerCleaner
from wisent.synthetic.cleaners.deduper_cleaner import DeduperCleaner
from wisent.synthetic.cleaners.methods.base_refusalers import BaseRefusaler
...
from wisent.synthetic.generators.pairs_generator import SyntheticContrastivePairsGenerator
