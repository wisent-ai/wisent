...
# Check if gpt3_translation_benchmarks is a group or task
try:
    task_dict = task_manager.load_task_or_group("gpt3_translation_benchmarks")
    print(f"Loaded gpt3_translation_benchmarks: {type(task_dict)}")
