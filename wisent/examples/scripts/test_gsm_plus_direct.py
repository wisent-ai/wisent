...
from wisent.core.contrastive_pairs.lm_eval_pairs.lm_task_extractors.gsm_plus import GSMPlusExtractor

# Load task
task_manager = TaskManager()
task_dict = task_manager.load_task_or_group("gsm_plus")
task_obj = list(task_dict.values())[0]

# Create extractor
extractor = GSMPlusExtractor()
