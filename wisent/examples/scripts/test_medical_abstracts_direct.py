...
from wisent.core.contrastive_pairs.lm_eval_pairs.lm_task_extractors.medical_abstracts import MedicalAbstractsExtractor

# Load task
task_manager = TaskManager()
task_dict = task_manager.load_task_or_group("medical_abstracts")
task_obj = list(task_dict.values())[0]

# Create extractor
extractor = MedicalAbstractsExtractor()
