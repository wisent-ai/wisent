...
# Check if ja_leaderboard_jaqket_v2 is a group or task
try:
    task_dict = task_manager.load_task_or_group("ja_leaderboard_jaqket_v2")
    print(f"Loaded ja_leaderboard_jaqket_v2: {type(task_dict)}")
