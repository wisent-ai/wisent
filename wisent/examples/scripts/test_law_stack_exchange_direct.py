...
from wisent.core.contrastive_pairs.lm_eval_pairs.lm_task_extractors.law_stack_exchange import LawStackExchangeExtractor
...
# Create extractor
extractor = LawStackExchangeExtractor()
