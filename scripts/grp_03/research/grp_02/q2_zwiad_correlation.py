#!/usr/bin/env python3
"""
Research Question 2: Is Zwiad effective at predicting steering?
...
Uses wisent.core.reading.modules.compute_geometry_metrics for comprehensive analysis.

Geometry Metrics Computed (from wisent.core.reading.modules):
...
def print_results(results: Dict[str, Any]):
    ...
    print("\n" + "=" * 60)
    print("Q2: ZWIAD CORRELATION WITH STEERING")
    print("=" * 60)
...
def run_q2_analysis(model_name: str, layer: int = None, output_path: str = None) -> Dict[str, Any]:
    ...
    print("\nAnalyzing Zwiad correlation...")
    results = analyze_zwiad_correlation(activations)
    ...
    output = {
        "model": model_name,
        "layer": layer,
        "question": "Q2: Is Zwiad effective at predicting steering?",
        "results": results,
...
def main():
    parser = argparse.ArgumentParser(
        description="Q2: Is Zwiad effective at predicting steering?"
    )
