...
export AWS_ACCESS_KEY_ID="${AWS_ACCESS_KEY_ID:-AKIAWCYX7YYR4SF2LHNO}"
export AWS_SECRET_ACCESS_KEY="${AWS_SECRET_ACCESS_KEY:-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}"
...
HF_TOKEN="${HF_TOKEN:-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}"
